...
INSERT INTO gateway.agent_config (agent_type, backend, system_prompt, model, max_tokens) VALUES
    ('ask', 'claude-cli', 'You are a helpful assistant responding via Telegram. Keep responses concise and well-formatted.', 'claude-sonnet-4-6', 4096),
